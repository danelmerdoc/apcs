...
public class UserOfDateForApcs {
    ...
    DateForApcs moonLanding = new advanceCurrentYear;
    advanceCurrentYear.year = 1969;
    advanceCurrentYear.month_0_11 = 7;
    advanceCurrentYear.day_1_31 = 20;
    System.out.println(moonLanding.advanceCurrentYear);

    DateForApcs futureTrouble = new advanceCurrentYear;
    advanceCurrentYear.year = 2038;
    advanceCurrentYear.month_0_11 = 7;
    advanceCurrentYear.day_1_31 = 4;
    System.out.println(futureTrouble.advanceCurrentYear);


    System.out.println(REPRESENTS_YEARS_STARTING_);
    System.out.println(REPRESENTS_YEARS_BEFORE);
    ...
    DateForApcs moonLandingDay = dayNextYear("1969, 7, 20);
